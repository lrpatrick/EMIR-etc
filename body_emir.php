...
function endsWith($haystack, $needle) {
	...
	$filter_vals        =  array("Y", "J", "H", "Ks", "F123M", "FeII", "BrG", "H2(1-0)", "H2(2-1)"); // Y, F123M, H10, H21 Added by LRP 
  ...
  //  - label: Text to be displayed near the field
	...
	$FIELDS = array (
		'magnitude'       => array('group' => 0, 'label' => 'Magnitude',           'type' => "Number", 'min' => '0', 'step' => '0.01', 'value' => "0.0",    'unit' => "Vega System" ),
		'source_type'     => array('group' => 0, 'label' => 'Source Type',         'type' => "Select",
		                           'values' => $source_type_vals,                  'value' => "Point",  'unit' => "",
	...
	'onChange' => 'var new_unit = (this.value==\'Extended\') ? \'x10<sup>-16</sup> erg/s/cm<sup>2</sup>/arcsec<sup>2</sup>\' : \'x10<sup>-16</sup> erg/s/cm<sup>2</sup>\'; document.getElementById(\'unit_line_peakf\').innerHTML=new_unit;'),
		...
		'template'        => array('group' => 1, 'label' => 'Template',  'type' => "Select",
                           'values' => $template_vals,                         'value' => "Black body", 'unit' => "", 'dependID'=>'template'),


		'model'           => array('group' => 1, 'label' => 'Model',               'type' => "Select", 'values' => $model_vals,
                               'value' => "k2iii",                             'unit' => "",
                               'info' => 'You will choose one of the preloaded models form the Pickles Stellar Library',
                               'depend' => "template:$template_vals[0]"),
		'body_temp'       => array('group' => 1, 'label' => 'B. Body temperature', 'type' => "Number", 'value' => "10000",  'unit' => "K",
                               'min' => 0, 'step' => '0.01', 'depend' => "template:$template_vals[1]"),
		'line_center'     => array('group' => 1, 'label' => 'Line center',         'type' => "Number", 'value' => "2.26",    'unit' => "microns",
															 'info' => 'This value depend on the filter/grism. Reference values are available at EMIR website',
                               'url' => 'http://www.iac.es/proyecto/emir/pages/observing-with-emir/observing-tools.php',
                               'depend' => "template:$template_vals[2]"),
		'line_fwhm'       => array('group' => 1, 'label' => 'Line FWHM',           'type' => "Text", 'value' => "1.5",    'unit' => "Angstrom",
                               'depend' => "template:$template_vals[2]"),
		'line_peakf'      => array('group' => 1, 'label' => 'Total line flux',      'type' => "Text", 'value' => "1.0",
                               'unit' => "x10<sup>-16</sup> erg/s/cm<sup>2</sup>",          'depend' => "template:$template_vals[2]"),
		'model_file'      => array('group' => 1, 'label' => 'Model file',          'type' => "File",       'value' => "", 'unit' => "",
		...
		'airmass'         => array('group' => 2, 'label' => 'Airmass',             'type' => "Number", 'value' => "1.5",    'unit' => "",
                               'info' => 'The Airmass of the observed target. Must be between 1 and 2.',
                               'min' => 1, 'max' => 2, 'step' => 0.01),
		'seeing'          => array('group' => 2, 'label' => 'Seeing',              'type' => "Number", 'value' => "0.8",    'unit' => "arcsec",
                               'min' => 0, 'step' => '0.01',
		...
		'operation'       => array('group' => 3, 'label' => 'Operation',           'type' => "Select",
		                           'values' => $operation_vals, 'value' => "Photometry",  'unit' => "", 'dependID' => 'operation'),

		'photo_filter'    => array('group' => 3, 'label' => 'Filter',              'type' => "Radio",'values' => $filter_vals, 'value' => "Ks",
                               'unit' => "", 'depend' => "operation:$operation_vals[0]", 'function' => "filterLineCenter"),

		'photo_exp_time'  => array('group' => 3, 'label' => 'Exp. time',           'type' => "Text", 'value' => "1-10",   'unit' => "seconds",
		...
		'photo_nf_obj'    => array('group' => 3, 'label' => '# frames: Object',    'type' => "Text", 'value' => "1",'unit' => "",
                               'info' => 'Number of on and off target images', 'depend' => "operation:$operation_vals[0]", 'nobr' => 1),
		'photo_nf_sky'    => array('group' => 3, 'label' => 'Sky',                 'type' => "Text", 'value' => "1",    'unit' => "",
                               'depend' => "operation:$operation_vals[0]"),
		'spec_grism'      => array('group' => 3, 'label' => 'Grism',               'type' => "Radio",'values' => $grism_vals, 'value' => "K",
                               'unit' => "", 'depend' => "operation:$operation_vals[1]", 'function' => "filterLineCenter"),
		'spec_slit_width' => array('group' => 3, 'label' => 'Slit width',          'type' => "Text", 'value' => "0.8",  'unit' => "arcsec",
                               'depend' => "operation:$operation_vals[1]"),
		'spec_exp_time'   => array('group' => 3, 'label' => 'Exp. time',           'type' => "Text", 'value' => "100", 'unit' => "seconds",
                               'info' => 'Single number: single calculation of the S/N for this time will be performed<br />Range: S/N will be calculated for the whole range',
                               'depend' => "operation:$operation_vals[1]"),
		'spec_nf_obj'     => array('group' => 3, 'label' => '# frames: Object',    'type' => "Text", 'value' => "1", 'unit' => "",
                               'info' => 'Number of on and off target images', 'depend' => "operation:$operation_vals[1]", 'nobr' => 1),
		'spec_nf_sky'     => array('group' => 3, 'label' => 'Sky',                 'type' => "Text", 'value' => "1",    'unit' => "",
                               'depend' => "operation:$operation_vals[1]"),
		'submit'     => array('group' => 3, 'label' => 'Calculate',                'type' => "Submit",'value' => "Calculate", "unit" => ""),
	);
