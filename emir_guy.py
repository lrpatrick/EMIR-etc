...
#       if ff['photo_filter']=='Y':  # added by LRP 28-11-2016
#           val1, val2 = 0.965, 1.097  # added by LRP 28-11-2016
#       elif ff['photo_filter']=='J':  # Updated by LRP 28-11-2016
#           val1, val2 = 1.126, 1.397
#       elif ff['photo_filter']=='H':
#           val1, val2 = 1.420, 1.861
#       elif ff['photo_filter']=='Ks':
...
#     ['magnitude', 'Magnitude', 'float', None, None, 0, None],
#     ['source_type', 'Source Type', 'select', ['Extended', 'Point']],
#     ['template', 'Spectral Template', 'select', ['Model library', 'Black body', 'Emission line', 'Model file']],
#     ['model', 'Model', 'select', ["b0i", "b1i", "b3i", "b5i", "b8i", "a0i",
#                                   "a2i", "f0i", "f5i", "f8i", "g0i", "g2i",
#                                   "g5i", "g8i", "k2i", "k3i", "k4i", "m2i",
#                                   "o8iii", "b3iii", "b5iii", "b9iii", "a0iii",
#                                   "a3iii", "a5iii", "a7iii", "f0iii", "f2iii",
#                                   "f5iii", "g0iii", "g5iii", "g8iii", "k0iii",
#                                   "k1iii", "k2iii", "k3iii", "k4iii", "k5iii",
#                                   "m0iii", "m1iii", "m2iii", "m3iii", "m4iii",
#                                   "m5iii", "m6iii", "m7iii", "m8iii", "m9iii",
#                                   "m10iii", "o5v", "o9v", "b0v", "b1v", "b3v",
#                                   "b8v", "b9v", "a0v", "a2v", "a3v", "a5v",
#                                   "a7v", "f0v", "f2v", "f5v", "f6v", "f8v",
#                                   "g0v", "g2v", "g5v", "g8v", "k0v", "k2v",
#                                   "k3v", "k4v", "k5v", "k7v", "m0v", "m1v",
#                                   "m2.5v", "m2v", "m3v", "m4v", "m5v", "m6v",
#                                   ]],
#     ['body_temp', 'Body temperature', 'float', 'Black body', None, 0, None],
#     ['line_center', 'Line center', 'float', 'Emission line', None, val1, val2],
#     ['line_fwhm', 'Line FWHM', 'float', 'Emission line', None, 0, None],
#     ['line_peakf', 'Line peak flux', 'float', 'Emission line', None, 0, None],
#     ['airmass', 'Airmass', 'float', None, None, 1.0, 2.0],
#     ['seeing', 'Seeing', 'float', None, None, 0, None],
#     ['operation', 'Operation', 'select', ['Photometry', 'Spectroscopy']],
#     ['photo_exp_time', 'Exp. time', 'range', None, 'Photometry', 0, None],
#     ['photo_nf_obj', '#Frames:obj', 'float', None, 'Photometry', 0, None],
#     ['photo_nf_sky', '#Frames:sky', 'float', None, 'Photometry', 0, None],
#     ['photo_filter', 'Filter', 'select', ['Y', 'J', 'H', 'Ks', 'BrG', 'FeII',
#                                           'F123M', 'H2(1-0)', 'H2(2-1)']],
#     ['spec_slit_width', 'Slit Width', 'float', None, 'Spectroscopy', 0, None],
#     ['spec_grism', 'Grism', 'select', ['J', 'H', 'K', 'YJ', 'HK']],
#     ['spec_exp_time', 'Exp. time', 'range', None, 'Spectroscopy', 0, None],
#     ['spec_nf_obj', '#Frames:obj', 'float', None, 'Spectroscopy', 0, None],
#     ['spec_nf_sky', '#Frames:sky', 'float', None, 'Spectroscopy', 0, None],
...
#   for elems in DATA_INPUT:
#     if elems[TYPE] != 'select' and ((not elems[TEMPL] is None and ff['template'] != elems[TEMPL]) or (not elems[OPER] is None and ff['operation'] != elems[OPER])):
# 			# This field is not needed for the present template/operation
#       continue
...
#       # Check range
#       if (elems[MIN] is not None and float(val) < float(elems[MIN])) or (elems[MAX] is not None and float(val) > float(elems[MAX])):
#           #print elems[MIN], elems[MAX], val
#           errorxml(output, "Value of " + elems[TITLE] + " is out of range [" + str(elems[MIN]) + ", " + str(elems[MAX]) + "]")
#           error = True

#     elif elems[TYPE] == 'select':
#       if not val in elems[VALUES]:
#         errorxml(output, "Value of " + elems[TITLE] + " is not one of the elements in the list")
#         error = True
...
#       #print str(rval)
#       if len(rval) != 2:
#         errorxml(output, "Value of " + elems[TITLE] + " is not a valid range ")
#         error = True
#         continue
...
#         float(rval[1])
#       except:
#         errorxml(output, "Value(s) of " + elems[TITLE] + " are not valid numbers")
#         error = True
#         continue

#       if float(rval[0]) > float(rval[1]):
#         errorxml(output, "Min value of " + elems[TITLE] + " is greater than max value")
#         error = True

#     else:
#       errorxml(output, "Value of " + elems[TITLE] + "has not a valid type")
#       error = True
